...
namespace ProviderPresets
{
	...
	const TArray<FProviderPreset>& GetAllProviderPresets()
	{
		static const TArray<FProviderPreset> Presets =
		{
			...
			FProviderPreset{ TEXT("kimi"), TEXT("Kimi (Moonshot)"), EAiProviderKind::OpenAiChatCompat, TEXT("https://api.moonshot.ai/v1/chat/completions"), TEXT("moonshot-v1-8k"), TEXT(""), TEXT(""), TEXT("") },
			FProviderPreset{ TEXT("glm"), TEXT("GLM (Zhipu)"), EAiProviderKind::OpenAiChatCompat, TEXT("https://api.z.ai/api/paas/v4/chat/completions"), TEXT("glm-4"), TEXT(""), TEXT(""), TEXT("") },
