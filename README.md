...
- 149 registered MCP tools across actors, blueprint, editor, material, memory, scaffold, self-extension, skills, and widget categories.
...
- 已注册 149 个 MCP tools，覆盖 actors、blueprint、editor、material、memory、scaffold、self-extension、skills、widget 分类。
...
- actors、blueprint、editor、material、memory、scaffold、self-extension、skills、widget カテゴリにまたがる 149 個の MCP tools を登録済みです。
