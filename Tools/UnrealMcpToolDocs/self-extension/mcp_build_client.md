...
Runs Unreal Build Tool for the dedicated-client target, captures logs, parses errors, and writes build status memory.
...
```json
{
  ...
  "properties": {
    ...
    "memoryKey": {
      ...
      "default": "mcp.extension.build_client"
    },
    "writeProjectMemory": {
      "type": "boolean",
...
- Reason: Explicit registry: UBT target matrix build tool for dedicated-client compile coverage.
