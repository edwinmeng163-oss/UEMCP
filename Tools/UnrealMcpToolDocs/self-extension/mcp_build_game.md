...
Runs Unreal Build Tool for the standalone game target, captures logs, parses errors, and writes build status memory.
...
```json
{
  ...
  "properties": {
    ...
    "memoryKey": {
      ...
      "default": "mcp.extension.build_game"
    },
    "writeProjectMemory": {
      "type": "boolean",
...
- Reason: Explicit registry: UBT target matrix build tool for standalone game compile coverage.
